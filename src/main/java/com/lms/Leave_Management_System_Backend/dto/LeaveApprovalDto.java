...
public class LeaveApprovalDto {
    ...
    public LeaveApprovalDto(Integer id, Integer requestId, Integer approverId, String approverName,
                           Integer actingAsDelegateFor, Integer level, String decision,
                           LocalDateTime decidedAt, String comments) {
        this.id = id;
