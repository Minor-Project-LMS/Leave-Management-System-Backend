...
public class UserNotificationPreference {
    ...
    public Boolean getLeaveRequestUpdates() { return leaveRequestUpdates; }
    public void setLeaveRequestUpdates(Boolean leaveRequestUpdates) { this.leaveRequestUpdates = leaveRequestUpdates; }

    public Boolean getApprovalNotifications() { return approvalNotifications; }
    public void setApprovalNotifications(Boolean approvalNotifications) { this.approvalNotifications = approvalNotifications; }

    public Boolean getCompOffUpdates() { return compOffUpdates; }
    public void setCompOffUpdates(Boolean compOffUpdates) { this.compOffUpdates = compOffUpdates; }
    ...
    public Boolean getHolidayReminders() { return holidayReminders; }
    public void setHolidayReminders(Boolean holidayReminders) { this.holidayReminders = holidayReminders; }
